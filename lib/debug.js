...
exports.init = function() {
    if(global.program.develop) {
        global.configure.cron.FIND_TRADING_BEST_TIME.GRADE_1 = '30 */1 * * * *';
        global.configure.cron.FIND_TRADING_BEST_TIME.GRADE_2 = '30 */5 * * * *';
        global.configure.cron.FIND_TRADING_BEST_TIME.GRADE_3 = '30 */10 * * * *';
        global.configure.cron.FIND_TRADING_FAVORITE = '0 */1 * * * *'; //find
        global.configure.cron.SEND_TRADING_FAVORITE = '0 * * * * *'; //slack send
        global.configure.autoadd.min = 500;
    }
};
