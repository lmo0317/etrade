...
exports.getTradingList = function(param, callback) {
    var start = '20' + param.start + '0000';
    var end = '20' + param.start + '2359';
    Trading.find({date: {$gt:start, $lt:end}}, callback);
};
...
exports.findTrading = function(callback) {
    ...
    sync.fiber(function() {
        ...
        var date = moment();
        var minute = Math.floor(parseInt(date.format('MM')) / 20) * 20;
        ...
        var trading = {
            date: date.format('YYYYMMDDHH') + minute.padLeft(2,'0'),
            stocklist: []
        };
        ...
        for(var i=0;i < stocklist.length; i++)
        {
            ...
            trading.stocklist.push(tradingStock);
        }
